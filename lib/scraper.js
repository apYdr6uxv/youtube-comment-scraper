                ...
                return ph.createPage().then((page) => {
                    ...
                    return page.open(url).then((status) => {
                        ...
                        return new Promise((resolve, reject) => {
                            ...
                            // Check consent button has been loaded.
                            ...
                            function check_consent() {
                                page.evaluate(function() {
                                    ...
                                    if (res != null){
                                        page.evaluate(function () {
                                            return document.querySelector(".button[value='I agree']").click()
                                        })
                                        .then(check_header)
                                        .catch(reject)
                                    } else {
                                        // let ss = new Date().toISOString().replace(/:/g, "_");
                                        // page.render("../screenshots/" + ss + ".png", { format: "png", quality: 0 });
                                        setTimeout(check_consent, 1000)
                                    }
